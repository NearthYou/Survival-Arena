...
- 참가자 24명은 중심에서 반지름 20에서 26 사이의 고리에 배치한다.
...
| 구간 | 시간 | 반경 | 바깥 피해 |
| --- | ---: | ---: | ---: |
| 1단계 | 0초에서 120초 | 32에서 24 | 초당 2 |
| 2단계 | 120초에서 240초 | 24에서 16 | 초당 4 |
| 3단계 | 240초에서 360초 | 16에서 8 | 초당 8 |
| 4단계 | 360초에서 480초 | 8에서 2 | 초당 16 |
| Sudden death | 480초에서 600초 | 2에서 0 | 초당 32 |
